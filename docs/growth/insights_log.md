...
> The most important file. Log observations in real time. Keep it raw, not polished.
...
## Example Entries (delete when real data arrives)
...
_After 3+ days, note recurring patterns here:_
