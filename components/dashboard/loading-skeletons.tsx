    ...
    <div className="dashboard-panel p-5 sm:p-6 space-y-4">
      ...
      <div className="grid gap-3 sm:grid-cols-3">
        {Array.from({ length: 3 }, (_, i) => (
          <div key={i} className="space-y-2 dashboard-sub-panel p-3.5">
...
export function TenantTableSkeleton({ rows = 5 }: { rows?: number }) {
  return (
    <div className="dashboard-panel p-5 sm:p-6 space-y-3">
      <Shimmer className="h-4 w-32" />
    ...
    <div className="dashboard-panel p-5 sm:p-6 space-y-4">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        {Array.from({ length: 2 }, (_, i) => (
          <div key={i} className="dashboard-sub-panel p-4 space-y-3">
            <Shimmer className="h-3 w-24" />
