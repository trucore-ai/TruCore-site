      ...
      <Section divider className="fade-in-up fade-delay-1">
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <Card className="border-primary-300/25 bg-primary-500/10">
            <h2 className="text-2xl font-bold text-accent-300">Who this is for</h2>
          ...
          {/* What you get */}
          <Card className="border-primary-300/25 bg-primary-500/10">
            <h2 className="text-2xl font-bold text-accent-300">What you get</h2>
            <ul className="mt-4 space-y-3">
              {whatYouGet.map((item) => (
                <li key={item} className="flex items-start gap-3 text-lg text-slate-200">
          ...
          {/* What happens next */}
          <Card className="border-primary-300/25 bg-primary-500/10">
            <h2 className="text-2xl font-bold text-accent-300">What happens next</h2>
