      ...
      >
        ...
        <div style={{ position: "relative", zIndex: 1, display: "flex", flexDirection: "column", padding: "56px", width: "100%", height: "100%" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8, maxWidth: 900, marginBottom: 36 }}>
            ...
            <div style={{ fontSize: 56, fontWeight: 800, lineHeight: 1.08, color: "#ffffff", letterSpacing: "-0.02em" }}>for Autonomous</div>
            <div style={{ fontSize: 56, fontWeight: 800, lineHeight: 1.08, background: "linear-gradient(135deg, #f08a1f 0%, #f5a623 50%, #fbbf24 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", letterSpacing: "-0.02em" }}>Finance</div>
          </div>

          <div style={{ display: "flex", marginBottom: 40, maxWidth: 750 }}>
            <div style={{ fontSize: 22, color: "#88b8d8", lineHeight: 1.5 }}>Policy enforcement, agent payments & service discovery — all verifiable, all trustless.</div>
          </div>
            ...
            {products.map((p) => (
              <div
                ...
                style={{
                  ...
                  padding: "20px 22px", background: "rgba(15, 25, 45, 0.6)",
                  border: `1px solid ${p.color}22`, borderRadius: 14, position: "relative", overflow: "hidden",
                }}
              >
