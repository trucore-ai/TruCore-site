 ...
 * Includes OG image with receipt-specific preview when hash is provided.
 */
export async function generateMetadata({ searchParams }: PageProps): Promise<Metadata> {
  ...
  const ogImageUrl = hash
    ? `${BASE_URL}/api/og/receipt?hash=${encodeURIComponent(hash)}`
    : `${BASE_URL}/api/og/receipt`;
  ...
  return {
    ...
    openGraph: {
      ...
      description,
      type: "website",
      url: hash ? `${BASE_URL}/verify?hash=${encodeURIComponent(hash)}` : `${BASE_URL}/verify`,
      images: [
        {
          url: ogImageUrl,
          width: 1200,
