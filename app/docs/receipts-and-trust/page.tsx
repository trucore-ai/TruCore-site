    ...
    <article className="space-y-10">
      ...
      <div className="rounded-lg border border-blue-500/20 bg-blue-500/5 p-4">
        <p className="text-sm text-slate-300">
          ...
          . This page explains how receipts work in practice.
        </p>
      </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="rounded-lg border border-emerald-500/20 bg-emerald-500/5 p-5">
            ...
            <ul className="mt-2 space-y-1 text-sm text-slate-300">
              <li>The receipt content is intact &mdash; no fields were modified after issuance</li>
              <li>The decision matches the original policy evaluation</li>
              <li>The hash is consistent with the canonical payload</li>
              <li>Any tool following the same canonical encoding can independently verify</li>
            </ul>
          </div>
